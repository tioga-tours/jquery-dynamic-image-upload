	...
	DynamicImageUpload.prototype = {
		...
		speedTest: function ()
		{
			...
			if (typeof SpeedTest === 'undefined') {
				self.verbose('SpeedTest library is not included', 0);
				return;
			}

			var speedTest = new SpeedTest(self.options.speedTest);
			speedTest.benchUpload(function (speed) {
		...
		resizeImage: function (file, toSize, highQuality) {
			...
			image.onload = function () {
				...
				self.correctOrientation(ctx, canvas, file.orientation);
